...
<div class="container">
    ...
    <div class="row body">
        <form class="form-horizontal" id="updataDeptForm" action="${pageContext.request.contextPath}/dept/updataDept" method="post">
